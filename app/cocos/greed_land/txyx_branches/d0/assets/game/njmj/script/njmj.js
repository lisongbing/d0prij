...
cc.Class({
    ...
    checkBaoJiaoTwoCanPlayMj: function (qiPaiItemTwo) {
        let qCode = parseInt(qiPaiItemTwo.code)
        let canPlay = true
        for (let i = 0; i < this.huPaiCodeArr.length; i++) {
            let code = this.huPaiCodeArr[i]
            let gCode = parseInt(code)
            if (gCode == qCode) {
                canPlay = false
                break
            }
...
// 显示胡牌提示按钮
    ...
    addGangBtn: function () {
        ...
        if (!cc.g.utils.judgeArrayEmpty(codeArr)) {
            ...
            codeArr.forEach((code)=>{
                ...
                cc.g.utils.addClickEvent(htgitem, this, 'njmj', 'onClickGangClicked', htgitem);
                // add
    ...
    addHuBtn: function () {
        ...
        cc.g.utils.addClickEvent(htgitem, this, 'njmj', 'doClickHu', null);
        // add
        htgitemLayout.addChild(htgitem, 0, "");
        // add
        this.Node_HuTiGangView.addChild(htgitemLayout, 0, "");
    ...
    addPengFeiBtn: function (pf) {
        ...
        if (pf == 1) {
            cc.g.utils.addClickEvent(htgitem, this, 'njmj', 'doClickFei', null);
        } else if (pf == 2) {
            cc.g.utils.addClickEvent(htgitem, this, 'njmj', 'doClickPeng', null);
        }
        // add
        htgitemLayout.addChild(htgitem, 0, "");
        // add
    ...
    addGuoBtn: function () {
        ...
        cc.g.utils.removeClickAllEvent(htgitem);
        cc.g.utils.addClickEvent(htgitem, this, 'njmj', 'doClickGuo', null);
        // add
