...
let LocSettleView = cc.Class({
    ...
    show: function () {
        ...
        // 地区
        this.Label_diqu.string = '高县跑得快'; //cc.g.areaInfo[ri.origin].name + '跑得快';
        // 房间号
...
let LocSettleFinalView = cc.Class({
    ...
    upInfo: function () {
        ...
        //Label_diqu.string = (GM.xiaojjs ? '高县跑得快' : '高县跑得快(中途解散)');
        Label_diqu.string = '高县跑得快';
