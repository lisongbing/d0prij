...
let DEF = require('pdkgaoxDef');
let Logic = require('pdkgaoxLogic');
let Audio = require('pdkgaoxAudio');
let Player = require('pdkgaoxPlayer');
let MsgQueue = require('pdkgaoxMsgQueue');
let BackPlay = require('pdkgaoxBackPlay');
...
cc.Class({
    ...
    setNetworkMessageCallback: function () {
        ...
        // 结算结果通知
        cc.g.networkMgr.addHandler(PB.PROTO.NOTIFY_GAOX_PDK_PLAYER_RESULT_LIST, (resp) => {
