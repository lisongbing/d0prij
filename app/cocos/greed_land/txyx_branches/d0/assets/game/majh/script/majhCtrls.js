...
let MajhHandCardView = cc.Class({
    ...
    onTouchstart: function (event) {
        ...
        if (parseInt(tg.code) == 50  || this.pPage.isAutoPlay ||  this.pPage.isAutoHu) {
            return
        }
        ...
        let baolen = this.pPage.checkBaoJioaCanPlayMj()
        if (baolen == 14 && this.pPage.isBaoJiao) {
            if (!tg.zezao) {
                return
            }
        }
...
let D2SettleView = cc.Class({
    ...
    crtPlayerItem: function (vbPlayerContent, allPerResultItem) {
        ...
        cc.log('allPerResultItem--->' + JSON.stringify(allPerResultItem))
...
let D2SettleFinalView = cc.Class({
    ...
    upInfo: function () {
        ...
        Label_diqu.string = cc.g.areaInfo[ri.origin].name + '麻将';
