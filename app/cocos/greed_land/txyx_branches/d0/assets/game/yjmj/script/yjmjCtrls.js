...
let MajhHandCardView = cc.Class({
        ...
        for (let i = 0; i < cards.length; i++) {
            ...
            if (!cc.g.utils.judgeObjectEmpty(cardNode)) {
                ...
                if (deskId == 0) {
                    ...
                    cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                    cardNode.code = code
                }
                ...
                if (this.pPage.isbpm) {
                    ...
                    if (deskId == 1) {
                        let keys = 'ri_majh_cardval_' + code
                        if (cardType == 1) {
                            keys += '_1'
                        }
                        cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                    } else if (deskId == 2) {
                        let keys = 'to_majh_cardval_' + code
                        if (cardType == 1) {
                            keys += '_1'
                        }
                        cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                    } else if (deskId == 3) {
                        let keys = 'le_majh_cardval_' + code
                        if (cardType == 1) {
                            keys += '_1'
                        }
                        cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
        ...
        if (getRelDeskId == 0 || this.pPage.isbpm) {
            ...
            if (finPai == null) {
                ...
                if (getRelDeskId == 0) {
                    ...
                    cc.find("Sprite_cardVal", finPai).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
    ...
    changeHandleCardZhongTwo: function(gui, index) {
        ...
        for(let i=0; i<grp.length; i++){
            ...
            if (!cardNode.active) {
                let cardType = cc.g.utils.getPaiVaule(20);
                if (index == 0) {
                    let keys = 'majh_cardval_' + gui
                    if (cardType == 1) {
                        keys += '_1'
                    }
                    cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                } else if (index == 1) {
                    let keys = 'ri_majh_cardval_' + gui
                    if (cardType == 1) {
                        keys += '_1'
                    }
                    cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                } else if (index == 2) {
                    let keys = 'to_majh_cardval_' + gui
                    if (cardType == 1) {
                        keys += '_1'
                    }
                    cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                } else if (index == 3) {
                    let keys = 'le_majh_cardval_' + gui
                    if (cardType == 1) {
                        keys += '_1'
                    }
                    cc.find("Sprite_cardVal", cardNode).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
    ...
    showHuPaiView: function (palyerViewItem, code, lastV) { // 显示胡牌
        ...
        let keys = cardKeyName + code
        if (cardType == 1) {
            keys += '_1'
        }
        cc.find("Sprite_Hu/Sprite_Val", card).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
...
let MajhQiCardView = cc.Class({
    ...
    doAddOneDelay: function(cardNum, showPoint=false) {
        ...
        if (this.selfView.index == 0) {
            ...
            let keys = 'majh_cardval_' + cardNum
            if (cardType == 1) {
                keys += '_1'
            }
            cc.find("Sprite_cardVal", newCard).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
            ...
            // this.addChild(newCard, 1, 'Node_QiPai'+cards.length);
            let keys = 'ri_majh_cardval_' + cardNum
            if (cardType == 1) {
                keys += '_1'
            }
            cc.find("Sprite_cardVal", newCard).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
            ...
            let keys = 'to_majh_cardval_' + cardNum
            if (cardType == 1) {
                keys += '_1'
            }
            cc.find("Sprite_cardVal", newCard).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
            ...
            this.qiPai_handCard.addChild(newCard, zIndex, 'Node_QiPai'+lastLength);
            // this.addChild(newCard, 1, 'Node_QiPai'+cards.length);
            let keys = 'le_majh_cardval_' + cardNum
            if (cardType == 1) {
                keys += '_1'
            }
            cc.find("Sprite_cardVal", newCard).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
...
let MajhPongCardView = cc.Class({
    ...
    doAddGangPai: function(codeArr, index) {
        ...
        cc.find("Sprite_Gang0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + codeArr[1] + '_1') : (cardKeyName + codeArr[1]));
        cc.find("Sprite_Gang1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + codeArr[2] + '_1') : (cardKeyName + codeArr[2]));
        cc.find("Sprite_Gang2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + codeArr[3] + '_1') : (cardKeyName + codeArr[3]));
        cc.find("Sprite_Gang3/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + codeArr[4] + '_1') : (cardKeyName + codeArr[4]));
    ...
    doAddOnePongPai: function(cardObj) {
        ...
        if (cardObj.type == 'peng') {
            cc.find("Sprite_Peng0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + cardObj.code + '_1') : (cardKeyName + cardObj.code));
            cc.find("Sprite_Peng1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + cardObj.code1 + '_1') : (cardKeyName + cardObj.code1));
            cc.find("Sprite_Peng2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame((cardType == 1) ? (cardKeyName + cardObj.code2 + '_1') : (cardKeyName + cardObj.code2));
        ...
        for(let i=0; i<pongPaiArr.length; i++){
            ...
            for(let j=0; j<cards.length; j++){
                ...
                if (nodePong.type == cardItem.type) {
                    ...
                    let cardCode = cardKeyName + cardItem.code
                    ...
                    if (cardItem.type == 'peng') {
                        ...
                        cc.find("Sprite_Peng0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Peng1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Peng2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame((cardType == 1) ? (cardKeyName + 1 + '_1') : (cardKeyName + 1));
                    }
    ...
    upLeftcards: function () {
        ...
        if (!cc.g.utils.judgeArrayEmpty(rc)) {
            ...
            for (let i = 0; i < rc.length; ++i) {
                ...
                let cardCode = 'majh_cardval_' + rc[i]
                if (cardType == 1) {
                    cardCode += '_1'
                }

                sprite_cardVal_img.getComponent(cc.Sprite).spriteFrame = this.pg.majhCardAtlas0.getSpriteFrame(cardCode);
    ...
    crtPlayerItem: function (vbPlayerContent, allPerResultItem, maValue) {
        ...
        if (!cc.g.utils.judgeArrayEmpty(hand)) {
            ...
            for (let i = 0; i < hand.length; i++) {
                ...
                let keys = 'majh_cardval_' + cardcode
                if (cardType == 1) {
                    keys += '_1'
                }
