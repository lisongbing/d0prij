...
let MajhPlayerView = cc.Class({
    ...
    startSendCard(){
        ...
        // } else {
        //     this.handCardView.upReloadLastOne();
        // }
    },
...
let MajhPongCardView = cc.Class({
    ...
    doChangeZhongPai: function(code, gui) {
        ...
        for (let i = 0; i < this.pongPaiArr.length; i++) {
            ...
            let keys = ((cardType == 1) && (riAndLeft)) ? (cardKeyName + code + '_zhi') : (cardKeyName + code)//cardKeyName + code
                ...
                if (lastOneItem.type == 'fei' || lastOneItem.type == 'peng') {
                    ...
                    if (tong) {
                        if (code0 == gui) {
                            ...
                            cc.find("Sprite_Peng0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                            ...
                            cc.find("Sprite_Peng1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                            ...
                            cc.find("Sprite_Peng2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                    ...
                    if (tong) {
                        if (code0 == gui) {
                            cc.find("Sprite_Gang0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                            lastOneItem.code = code
                            // 显示提的牌
                            ...
                            cc.find("Sprite_Gang1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                            lastOneItem.code1 = code
                            // 显示提的牌
                            ...
                            cc.find("Sprite_Gang2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
                            lastOneItem.code2 = code
                            // 显示提的牌
                            ...
                            cc.find("Sprite_Gang3/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(keys);
    ...
    doAddGangPai: function(codeArr, index) {
        ...
        cc.find("Sprite_Gang0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + codeArr[1] + '_zhi') : (cardKeyName + codeArr[1]));
        cc.find("Sprite_Gang1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + codeArr[2] + '_zhi') : (cardKeyName + codeArr[2]));
        cc.find("Sprite_Gang2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + codeArr[3] + '_zhi') : (cardKeyName + codeArr[3]));
        cc.find("Sprite_Gang3/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + codeArr[4] + '_zhi') : (cardKeyName + codeArr[4]));
    ...
    doAddOnePongPai: function(cardObj) {
        ...
        if (cardObj.type == 'peng') {
            ...
            cc.find("Sprite_Peng1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + cardObj.code1 + '_zhi') : (cardKeyName + cardObj.code1));
            cc.find("Sprite_Peng2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + cardObj.code2 + '_zhi') : (cardKeyName + cardObj.code2));
            ...
            cc.find("Sprite_Gang1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + cardObj.code1 + '_zhi') : (cardKeyName + cardObj.code1));
            cc.find("Sprite_Gang2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + cardObj.code2 + '_zhi') : (cardKeyName + cardObj.code2));
            cc.find("Sprite_Gang3/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = this.pPage.majhCardAtlas0.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + cardObj.code3 + '_zhi') : (cardKeyName + cardObj.code3));
        ...
        for(let i=0; i<pongPaiArr.length; i++){
            ...
            for(let j=0; j<cards.length; j++){
                ...
                if (nodePong.type == cardItem.type) {
                    ...
                    let cardCode = ((cardType == 1) && (riAndLeft)) ? (cardKeyName + cardItem.code + '_zhi') : (cardKeyName + cardItem.code)//cardKeyName + cardItem.code

                    if (cardItem.type == 'peng') {
                        cc.find("Sprite_Peng0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Peng1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Peng2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                    } else if (cardItem.type == 'mkang') { // 明杠
                        cc.find("Sprite_Gang0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Gang1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Gang2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Gang3/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                    } else if (cardItem.type == 'akang') { // 暗杠
                        cc.find("Sprite_Gang0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                    } else if (cardItem.type == 'fei') { // 飞牌
                        cc.find("Sprite_Peng0/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Peng1/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(cardCode);
                        cc.find("Sprite_Peng2/Sprite_Val", Layout_Top).getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame(((cardType == 1) && (riAndLeft)) ? (cardKeyName + 1 + '_zhi') : (cardKeyName + 1));
                    }
    ...
    upLeftcards: function () {
        ...
        if (!cc.g.utils.judgeArrayEmpty(rc)) {
            ...
            for (let i = 0; i < rc.length; ++i) {
                ...
                // cardNode.setPosition(cardNode.x, cardNode.y + cardNode.height*0.5)
              ...
              //              continue;
               ...
               // }
                ...
                if (ming == 7) {
                    if (guiNum == 1) {
                        guiTxtStr = '1归'
                        // mingTxt.getComponent(cc.Label).string = '1归、'
    ...
    showMaFunc: function() {
        ...
        if (!cc.g.utils.judgeArrayEmpty(maValue)) {
            ...
            for (let i = 1; i < maValue.length; ++i) {
                ...
                let keys = 'majh_cardval_' + code
                // if (cardType == 1) {
                //     keys += '_1'
                // }

                sprite_cardVal_img.getComponent(cc.Sprite).spriteFrame = this.pg.majhCardAtlas0.getSpriteFrame(keys);
...
let D2SettleFinalView = cc.Class({
    ...
    upInfo: function () {
        ...
        Label_diqu.string = '幺鸡麻将' //cc.g.areaInfo[ri.origin].name + '麻将';
