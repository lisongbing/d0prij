...
let LogicXw = require('pdkLogicXw');
...
cc.Class({
    ...
    init: function (roomInfo, player, otherPlayers) {
        ...
        // 逻辑模块
        if (! this.logic) {
            this.logic_pt = new Logic();//普通
            this.logic_xw = new LogicXw();//兴文

            this.logic_pt.init(this);
            this.logic_xw.init(this);
        }
        

        if (roomInfo.origin == 3) {
            cc.log('使用兴文逻辑');
            this.logic = this.logic_xw;//兴文
        } else {
            cc.log('使用普通逻辑');
            this.logic = this.logic_pt;
        }
    ...
    newPlayerJoined: function (player) {
        cc.log(this.dbgstr('newPlayerJoined'), player.name);
        ...
        this.onPlayerReady('PlayerJoined');
    },
    ...
    upJipaiqi: function (codes, isreset, cardRecord) {
        ...
        if (isreset) {
            ...
            if (this.guiDefnum==2) {
                this.jpqData[3] = 2;
            } else if (this.guiDefnum==4) {
                this.jpqData[3] = 0;
            } else if (this.guiDefnum==8) {
                this.jpqData[3] = 0;
                this.jpqData[4] = 0;
            }
        }
    ...
    playerQuited: function (player) {
        ...
        if (! this.isGameEndFinal) {
            ...
            this.onPlayerReady('playerQuited');
        }
    },
    //清除游戏数据
