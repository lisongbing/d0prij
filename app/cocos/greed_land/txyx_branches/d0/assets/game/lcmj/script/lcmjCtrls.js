...
let MajhHandCardView = cc.Class({
    ...
    onTouchstart: function (event) {
        ...
        let canplay = this.pPage.checkBaoJiaoCanPlayMj(tg)

        if (parseInt(tg.code) == 50 || tg.zezao || this.pPage.isAutoPlay || !canplay) {
            return
        }
...
let D2SettleFinalView = cc.Class({
    ...
    upInfo: function () {
        ...
        Label_diqu.string = '隆昌麻将'//cc.g.areaInfo[ri.origin].name + '麻将';
    ...
    upView: function () {
        ...
        // 地区
        // this.Label_diqu.string = (this.pg.gameMgr.xiaojjs ? '隆昌麻将' : '隆昌麻将(中途解散)');
