...
export default class TeaClass extends cc.Component {
    ...
    renderTeaRoomView(item: any, refreshDesk: boolean) {
        ...
        // @ts-ignore
        if ((gameType == GMID.XZMJ) || (gameType == GMID.XZMJER) ||(gameType == GMID.YJMJ) || (gameType == GMID.HZMJ) || (gameType == GMID.YBMJ) || (gameType == GMID.NYMJ) || (gameType == GMID.LZMJ) || (gameType == GMID.NJMJ) || (gameType == GMID.GXMJ)) {
            // deskName = '血战麻将';
    ...
    renderTeaRoomViewSec(item: any, refreshDesk:boolean) {
        ...
        let playNum = item.playNum
        // @ts-ignore
        if ((gameType == GMID.XZMJ) || (gameType == GMID.YJMJ) || (gameType == GMID.XZMJER) || (gameType == GMID.HZMJ) || (gameType == GMID.YBMJ) || (gameType == GMID.NYMJ) || (gameType == GMID.LZMJ) || (gameType == GMID.NJMJ) || (gameType == GMID.GXMJ)) {
            // deskName = '血战麻将';
            let preIndex = playNum - 2;
            if (this.useSecdDesk) {
                cardNode = cc.instantiate(this.mjDesk2Pre[preIndex]);
